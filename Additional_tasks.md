...
что бы создать дполнительные ноды нужно раскоментировать кодя ля создания дополнительных нод! это убыстрит работу с облаком! slave серевера автоматически будут настроены для работы с master нодой 
