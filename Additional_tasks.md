...
что бы создать дополнительные ноды нужно раскоментировать код и выполнить скрипт terraform снова, для создания дополнительных нод! Это убыстрит работу с облаком! Slave серевера автоматически будут настроены для работы с master нодой 
