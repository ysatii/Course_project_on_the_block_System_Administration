...
2.	Установка необходимых пакетов с использованием ansible.
...
3.	Развертывание zabbix
 ...
 - Бэкапирование БД сериса zabbix, что бы можно было сохранять дашборд не делая их каждый раз
