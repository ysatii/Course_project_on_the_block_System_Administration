...
## за счет использmpdjfybz комллекций мыв можем существенно расширить функционал ansible

, если у Вас нет коллекий запустите этот файл для установки коллекций
